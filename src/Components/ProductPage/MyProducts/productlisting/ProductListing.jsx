...
import {GET_STORE_PRODUCT_LIST} from '../../../../utils/api';
...
/* const ProductListing=()=>{
  ...
  const productlist = useSelector((state) => {
    console.log('Product List from Redux:', state.userproduct.product);
    return state.userproduct.product;
});
  ...
  const getproducts=async()=>{
    try {
        const response = await api.post(GET_STORE_PRODUCT_LIST);
