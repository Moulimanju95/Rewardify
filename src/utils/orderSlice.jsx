...
const orderSlice = createSlice({
    ...
    initialState: {
        orders: [{ _id:'12345',date:'Apr 09, 2024',name:'Rajesh Kannan',order:[ {item:'Ooty apple',count:'1',price:'₹100.00'},
            {item:'White Egg',count:'5',price:'₹50.00'}],total_price:'₹150.00'},{ _id:'14235',date:'May 06, 2024',name:'Rajesh Kannan',order:[ {item:'Ooty Tomato',count:'1',price:'₹10.00'},
            {item:'White Egg',count:'5',price:'₹50.00'}],total_price:'₹60.00'},{ _id:'18435',date:'Jan 18, 2024',name:'Rajesh Kannan',order:[ {item:'Coriander',count:'1',price:'₹20.00'},
            {item:'Chocolate',count:'5',price:'₹100.00'}],total_price:'₹120.00'},{ _id:'28435',date:'Apr 01, 2024',name:'Rajesh Kannan',order:[ {item:'Sun Flower',count:'1',price:'₹20.00'},
